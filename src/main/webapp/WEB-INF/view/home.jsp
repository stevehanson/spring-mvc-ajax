...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#randomPerson').click(function () {
            $.get('${pageContext.request.contextPath}/api/person/random', function (person) {
                $('#personResponse').text(person);
            });
        });
        ...
        $('#newPersonForm').submit(function (e) {
            ...
            $.post('${pageContext.request.contextPath}/api/save', $(this).serialize(), function (response) {
